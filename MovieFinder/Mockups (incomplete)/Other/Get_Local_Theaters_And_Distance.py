...
for x in theater_containers: # Loops over every theater and gets only the name
    ...
    theaterName = x.a.text # Location of all of the names of all of the movie theaters
